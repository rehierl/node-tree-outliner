...
is, because both are defined with regards to two related sections. In addition
to that, the term "parent section" may still refer to one of multiple different
